...
public class SepConsumerIT {
    ...
    @Before
    public void setUp() throws /*Replication*/Exception, ZkConnectException, InterruptedException, KeeperException, IOException {
    ...
    @After
    public void tearDown() throws /*Replication*/Exception, IOException {
        sepConsumer.stop();
